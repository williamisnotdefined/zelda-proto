...
export const PLAYER_DASH_DISTANCE = 150;
export const PLAYER_DASH_PUSH_DISTANCE = 150;
export const PLAYER_DASH_PUSH_HALF_WIDTH = 36;
export const PLAYER_DASH_DOUBLE_TAP_WINDOW = 250;
export const PLAYER_DASH_COOLDOWN = 5000;
export const PLAYER_WAVE_COOLDOWN = 1000;
