...
export const PLAYER_SPIKED_BALLS_COOLDOWN = PLAYER_SHURIKEN_COOLDOWN;
export const PLAYER_SPIKED_BALLS_DURATION_MS = PLAYER_SHURIKEN_DURATION_MS;
export const PLAYER_SPIKED_BALLS_RADIUS = 240;
...
export const PLAYER_CONFUSION_COOLDOWN = 40000;
export const PLAYER_CONFUSION_DURATION_MS = 20000;
