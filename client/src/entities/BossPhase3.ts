...
export class BossPhase3Entity {
  ...
  constructor(
    ...
    this.label = scene.add.text(x, y - LABEL_OFFSET_Y, labelText, {
      fontSize: '12px',
      color: '#ffdf8d',
      fontStyle: 'bold',
      align: 'center',
    ...
    this.hpBar = scene.add.rectangle(x, y - HP_BAR_OFFSET_Y, HP_BAR_WIDTH, 6, 0xffcc66);
  ...
  private updateAnimation(): void {
    ...
    const fallbackKey = `${this.animPrefix}_down`;
