// Package bossregion owns the player-relative boss respawner. A "region" is a
// regionSize grid cell; when a player is within ActiveRange of a cell center the boss
