...
import { ClientErrorLogStore } from './monitoring/clientErrorLogStore.js';
...
const clientErrorLogStore = new ClientErrorLogStore();
const httpServer = createHttpServer(clientErrorLogStore);
...
gameLoop.start();
console.log(`Client error logs: ${clientErrorLogStore.getLogDir()}`);
