...
// used by the legacy Node server.
package id
...
// Alphabet is the URL-safe nanoid alphabet (A-Za-z0-9_-) used by the legacy
// Node server when persisting session tokens.
const Alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_-"

// DefaultTokenLength matches the nanoid default of 21 characters used by the
// Node server for session tokens.
