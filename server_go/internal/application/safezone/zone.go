// Package safezone owns the spawn-area protection rules. The TypeScript
// reference server keeps these rules in src/game/systems/SafeZoneSystem.ts;
// the Go port collects them here so every consumer (hazard ticking, contact
// damage, PvP, AI targeting) reads from a single authoritative source.
//
