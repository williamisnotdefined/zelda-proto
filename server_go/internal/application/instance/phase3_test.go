...
// they died — the Go server only seeded them at construction and never
// refreshed their spawn anchor on player entry. Mirrors
// InstanceManager.transferPlayer in the TS reference server.
