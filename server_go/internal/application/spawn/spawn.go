// Package spawn ports the chunk-based monster spawner from
// server/src/game/systems/SpawnSystem.ts. Chunks are activated around
...
// pacmanVariants matches client/server canonical order.
...
// seededRandom mirrors shared/src/utils.ts (32-bit semantics via int32).
