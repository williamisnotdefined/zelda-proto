...
// covers all kinds, mirroring the legacy Blob inheritance hierarchy.
package enemy
...
// Kind identifies the enemy variant. Mirrors shared/src/types.ts.
type Kind string
...
// Variant configurations matching the TS values.
var (
	BlobConfig = Config{
...
// entering the spawn safe zone (reflects the legacy deflection rule).
